...
export const createNotification = async (notifRef, title, content, userRef) => {
    const sql = `
        INSERT INTO notification (notifRef, title, content, userRef, createdAt, isRead) 
