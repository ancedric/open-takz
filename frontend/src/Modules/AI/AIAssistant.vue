...
const chatHistory = ref([
  { role: 'assistant', text: t('ai.greatings') }
]);
  ...
  <div class="ai-floating-container" :class="{ 'minimized': isMinimized }">
    ...
    <div v-if="!isMinimized" class="ai-content">
      ...
      <div v-if="activeTab === 'suggestions'" class="ai-body">
        ...
        <div v-else class="empty-state">{{ t('ai.ongoing-analysis') }}</div>
      </div>
      ...
      <div v-if="activeTab === 'chat'" class="chat-container">
        ...
        <div class="input-area">
          <input v-model="userMessage" @keyup.enter="sendMessage" :placeholder="t('ai.ask-question')" />
...
.ai-floating-container.minimized {
  width: 40px; /* Réduit à une icône/bulle */
  height: 40px;
  border-radius: 30px;
  cursor: pointer;
}
